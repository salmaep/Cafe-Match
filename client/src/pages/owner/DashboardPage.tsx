...
export default function DashboardPage() {
  ...
  if (!dashboard?.hasCafe) {
    return (
      <div className="px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-3xl mx-auto">
        <h1 className="text-2xl lg:text-3xl font-bold text-[#1C1C1A] mb-5">
          Dashboard
        </h1>
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-5xl mx-auto">
      <h1 className="text-2xl lg:text-3xl font-bold text-[#1C1C1A] mb-1">
        Dashboard
      </h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        ...
        <StatCard
          label="Bookmarks"
          value={cafe?.bookmarksCount || 0}
          color="amber"
        />
        <StatCard
          label="Favorites"
          value={cafe?.favoritesCount || 0}
          color="red"
        />
      </div>
