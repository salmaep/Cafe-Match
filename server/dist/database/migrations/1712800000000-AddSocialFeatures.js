...
exports.AddSocialFeatures1712800000000 = void 0;
class AddSocialFeatures1712800000000 {
    ...
    `);
        const users = await queryRunner.query(`SELECT id FROM users WHERE friend_code IS NULL`);
...
exports.AddSocialFeatures1712800000000 = AddSocialFeatures1712800000000;
//# sourceMappingURL=1712800000000-AddSocialFeatures.js.map