...
export class AddScrapingFields1712900000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // 1. Add scraping-sourced columns to cafes
    ...
    // 2. cafe_purpose_tags — direct purpose-score link from review analysis
    await queryRunner.query(`
