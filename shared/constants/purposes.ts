 ...
 * shared between the web client (`client/`) and mobile app (`client-mobile/`).
 *
 ...
 * `/purposes` response, then passed to `cafesApi.search()`.
 */
...
const BY_LABEL: Record<string, PurposeOption> = Object.fromEntries(
  WIZARD_PURPOSES.map((p) => [p.label, p]),
);
...
export function getPurposeByLabel(label: string | undefined | null): PurposeOption | undefined {
